    ...
    widget.bind(SC.Widget.Events.PLAY_PROGRESS, function(data) {
        widget.getDuration(function(duration) {
            widget.getPosition(function(position) {
                ...
                if (position==0) {
                    document.getElementById('display_progress').style.background = 'url("https://umboniamusic.com/wp-content/uploads/2020/04/progress.gif") repeat-x scroll 0 0 #333333';
                } else if (position>0) {
                    document.getElementById('display_progress').style.background = 'none';
                }
